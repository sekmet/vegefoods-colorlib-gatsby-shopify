    ...
    render() {
        ...
        return (
            <>
                ...
                <div className="hero-wrap hero-bread" style={{background: `linear-gradient(rgba(20,20,20, .5),rgba(20,20,20, .5)), no-repeat center url('${fluid ? fluid.src : '/images/no-image.svg'}')`}}>
