...
path: /hello-world/
featuredImage: 
  src: /images/Static-vs-Dynamic.jpg
  alt: "An opinionated, yet adaptable approach to build enterprise-grade ecommerce, the JAMstack way"
description: "First things first. {static is} The New Dynamic is one of the best resources for developers and designers that are embracing the static web technology. It was founded by Bud Parr in 2014."
category: StaticGen
tags: ["Static", "New Dynamic", "Gatsby"]
editorpick: yes
tagline: ""
seo:
  title: Static is the New Dynamic
...
![Early Printing Press](/images/Printing-press.png)
...
![Movable metal type, and composing stick, descended from Gutenberg's press. Photo by Willi Heidelbach. Licensed under CC BY 2.5 ](/images/movable-type.jpg)
